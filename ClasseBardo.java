...
public class ClasseBardo extends Jogador {

    public ClasseBardo(String nome, int nivel, int idade, double altura, double peso, String linhagem, String antecedente, FichaGeral ficha){
